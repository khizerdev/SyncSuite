    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
                <form id="employe-type-form" action="{{ route('employee-types.store') }}" method="POST" data-method="POST"
                                >
                                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="holiday_ratio" name="holiday_ratio" step="0.01" min="0">
                </div>
                
                <div class="mb-3">
                    <label class="form-label">Overtime</label>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="overtime" id="overtime_yes" value="yes">
                        <label class="form-check-label" for="overtime_yes">Yes</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="overtime" id="overtime_no" value="no">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="overtime_ratio" name="overtime_ratio" step="0.01" min="0">
                </div>
  ...
  $(document).ready(function() {
      var dataTable = $('#table').DataTable({
          ...
          columns: [
              ...
              { data: 'overtime_ratio', name: 'overtime_ratio' },
              { data: 'holiday_ratio', name: 'holiday_ratio' },
