            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="btn btn-secondary" href="{{ url('/vendors') }}">View List</a>
                        </li>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select id="balance_type" name="balance_type" class="form-control">
                                                <option value="Credit"
                                                    {{ $vendor->balance_type == 'Credit' ? 'selected' : '' }}>Credit
                                                </option>
                                                <option value="Debit"
                                                    {{ $vendor->balance_type == 'Debit' ? 'selected' : '' }}>Debit</option>
                                                <option value="Other"
                                                    {{ $vendor->balance_type == 'Other' ? 'selected' : '' }}>Other</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
