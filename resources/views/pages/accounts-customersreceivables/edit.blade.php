            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('accounts-customersreceivables.update', $module->id) }}">
                                @csrf
                                @method('PUT')
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="customer_id" class="form-control ">
                                                            @foreach (\App\Models\Customer::all() as $customer)
                                                                <option
                                                                    @if ($module->customer_id == $customer->id) {{ 'selected' }} @endif
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group vendor_balance">
                                                        <label>Balance</label>
                                                        <input readonly class="old_balance form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="receive_in" class="form-control receive_in">
                                                            <option
                                                                @if ($module->receive_in == 'Account') {{ 'selected' }} @endif>
                                                                Account</option>
                                                            <option
                                                                @if ($module->receive_in == 'Vendor') {{ 'selected' }} @endif>
                                                                Vendor</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="account_id" class="form-control">
                                                            @foreach (\App\Models\Account::all() as $account)
                                                                <option
                                                                    @if ($module->receiver_id == $account->id) {{ 'selected' }} @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="vendor_id" class="form-control">
                                                            @foreach (\App\Models\Vendor::all() as $vendor)
                                                                <option
                                                                    @if ($module->receiver_id == $vendor->id) {{ 'selected' }} @endif
                                                ...
                                                <div class="col-md-3 cheque_date">
                                                    <div class="form-group">
                                                        ...
                                                        <input
                                                            value="@if ($module->cheque_date != null) {{ $module->cheque_date->format('M-d-Y') }} @endif"
                                                ...
                                                <div class="col-md-3 amount">
                                                    <div class="form-group">
                                                        ...
                                                        <input min="0" step=".01" value="{{ $module->amount }}"
                                                            required name="amount" type="number" class="form-control">
                                                    </div>
                                                </div>
