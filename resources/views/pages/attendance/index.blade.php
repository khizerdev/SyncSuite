                        ...
                        <form action="{{ route('attendance.view') }}" id="dateForm" class="card-body">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" value="department" type="radio" id="by-department"
                                        name="selection" required>
                                    <label for="by-department" class="custom-control-label">By Department</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" value="employee" type="radio" id="by-employee"
                                        name="selection" required>
