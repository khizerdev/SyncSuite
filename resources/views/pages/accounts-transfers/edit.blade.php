                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">Account Update</h3>
                        </div>
                        <form method="post" action="{{ route('accounts-transfers.update', $module->id) }}">
                            @method('PUT')
                            @csrf
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control trasnfer_from" name="sender_id">
                                                            @foreach ($accounts as $account)
                                                                <option
                                                                    @if ($account->id == $module->sender_id) {{ 'selected' }} @endif
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control trasnfer_to" name="receiver_id">
                                                            @foreach ($accounts as $account)
                                                                <option
                                                                    @if ($account->id == $module->receiver_id) {{ 'selected' }} @endif
                                                                    value="{{ $account->id }}">{{ $account->account_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input required type="date"
                                                        value="{{ \Carbon\Carbon::parse($module->date)->format('Y-m-d') }}"
                                                ...
                                                <div class="bal form-group col-md-3">
                                                    ...
                                                    <input required min="1" type="number" name="amount"
                                                        class="form-control amount" value="{{ $module->amount }}">
