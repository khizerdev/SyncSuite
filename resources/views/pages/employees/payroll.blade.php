                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <x-salary-details :employee="$result['employee']" :month="$month" :holidays="$result['holidays']" :working-days="$result['workingDays']"
                                    ...
                                    :paid-holiday-amount="$result['normalHolidayPay']" :holiday-ratio="$salary->holiday_pay_ratio" :over-time-ratio="$salary->overtime_pay_ratio" :total-over-time-hours-worked="$salary->overtime_hours"
                                    :total-over-time-minutes-worked="array_sum($overMinutes)" :total-overtime-pay="$result['totalOvertimePay']" :late-minutes="array_sum($absoluteMinutes)" :actual-salary-earned="$result['actualSalaryEarned']"
                                    :salary="$salary" />
