...
@section('content')
 <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form class="myform" method="post" action="{{route('inward-receipts.update',$receipt->id)}}" > 
            @csrf
            @method('PUT') 
                  ...
                  <div class="line-items" >
                      @foreach($receipt->items as $key => $item )
                        <div class="row py-1" > 
                              ...
                              <div class="col-md-2" >
                                <input name="items[{{$key}}][qty]" value="{{$item->qty}}" type="number" step=".01"  class="form-control" />
                              </div>
