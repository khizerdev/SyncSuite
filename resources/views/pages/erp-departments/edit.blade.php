            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <form action="{{ route('erp-departments.update', $erpDepartment->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="title" class="form-label">Title</label>
                    <input type="text" class="form-control" id="title" name="title" value="{{ $erpDepartment->title }}" required>
                    @error('title')
