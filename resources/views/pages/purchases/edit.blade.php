                    ...
                    <div class="row" >
                             ...
                             <div class="form-group">
                                ...
                                <div class="input-group">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" >PO-{{$module->date->format('ym')}}</span>
                                  </div>
                      ...
                      <div class="col-md-4" >
                        <div class="form-group">
                          ...
                          <input required name="date" value="{{ $module->date->format('Y-m-d') }}" type="date"  class="form-control" />
                         </div>       
                      </div>
                      ...
                      <div class="col-md-4" >
                        <div class="form-group">
                            ...
                            <select name="vendor_id" class="form-control" >
                                  ...
                                  <option @if($module->vendor_id == $vendor->id) {{'selected'}} @endif  data-address="{{$vendor->address}}"  data-id="{{$vendor->id}}" value="{{$vendor->id}}">{{$vendor->name}}</option>    
                                  @endforeach
                            </select>
                        </div>      
                      </div>
                      ...
                      <div class="col-md-12" >
                        <div class="form-group">
                           <label for="simpleinput">Address</label>
                            <input readonly type="text" value="{{$module->vendor->address}}" class="vendor_address form-control" />
                         </div>       
                      </div>
                   </div>
              </div>
                ...
                @csrf
                    ...
                    <!--Item Header-->
                     ...
                     <div class="line-items" >
                       ...
                       <div class="row py-1 " > 
                              <input class="line_item_id" type="hidden" name="items[{{$key}}][id]"  value="{{$item->id}}" />
                              
                              <div class="col-md-6" >
                                <input readonly name="items[{{$key}}][name]" class="form-control" value="{{$item->product->name}}" />
                                <input value="{{$item->product_id}}" name="items[{{$key}}][product_id]" type="hidden" /> 
                              </div>
                              <div class="col-md-5" >
                                <input min="1" step=".01" value="{{$item->qty}}" required name="items[{{$key}}][qty]" type="number"  class="form-control" />
                              </div>
                              <div class="col-md-1 align-self-center " >
